...
local function SaveProfileAsync(profile, release_from_session, is_overwriting)
	...
	while repeat_save_flag == true do
			...
			profile._profile_key,
			{
				...
				EditProfile = function(latest_data)
					...
					if is_overwriting ~= true then
						...
						if game:GetService('RunService'):IsStudio() then if not latest_data then return end end
						if game:GetService('RunService'):IsStudio() then if not latest_data.MetaData then return end end
		...
		if loaded_data ~= nil and key_info ~= nil then
			...
			if game:GetService('RunService'):IsStudio() then if not latest_meta_data then return end end
